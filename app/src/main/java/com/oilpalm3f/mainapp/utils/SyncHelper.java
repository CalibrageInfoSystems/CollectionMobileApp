...
import com.oilpalm3f.mainapp.BroadCastReciver.AlarmReceiver;
import com.oilpalm3f.mainapp.BroadCastReciver.DeviceBootReceiver;
...
public class SyncHelper {
    ...
    public static void scheduleRepeatingRTCNotification(Context context, String hour, String min) {
        ...
        alarmIntentRTC = PendingIntent.getBroadcast(context, ALARM_TYPE_RTC, intent, 0);
        ...
        alarmManagerRTC.setInexactRepeating(AlarmManager.RTC_WAKEUP,
                calendar.getTimeInMillis(), AlarmManager.INTERVAL_HOUR, alarmIntentRTC);
    }
    ...
    public static void scheduleRepeatingElapsedNotification(Context context) {
        ...
        Log.v("AlaramManager","interval of time"+AlarmManager.INTERVAL_DAY);
    }
